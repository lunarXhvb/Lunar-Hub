...
local Window = LUNARLibrary:Window({
	SubTitle = "",
...
Client = General:Label("Local Status");
function LUNARLibraryClient()
...
Client1 = General:Label("Local Status");
function LUNARLibraryClient1()
